  ...
  return (
    <Form onSubmit={(e)=>handleSubmit(e)} id="form-comment">
      <Label tag="h3">Adicione um comentário</Label>
        <FormGroup>
            <CgProfile  size={70} />
            <Input type="text" value={authorInput} placeholder="Nome" onChange={(e)=>{changeInputAuthor(e)}} />
        </FormGroup>
        <FormGroup>
            <Input type="textarea" id="textarea-comment"  value={commentsInput} placeholder="Comentário"  onChange={(e)=>{changeInputComments(e)}} />
        </FormGroup>
